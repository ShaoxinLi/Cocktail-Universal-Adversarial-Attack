...
class ConvNet(torch.nn.Module):
    ...
    def __init__(self, width=64, num_classes=10, num_channels=1):
...
def convnet(num_classes=10, num_channels=1):
    return ConvNet(width=64, num_classes=num_classes, num_channels=num_channels)